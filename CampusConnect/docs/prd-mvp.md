...
| Gruppen (Entdecken/Beitreten/Erstellen) | • Nutzer sieht Gruppenliste inkl. „discoverable“ Gruppen<br>• Nutzer kann öffentlicher Campusgruppe beitreten und eigene Campusgruppe erstellen |
| Gruppenverwaltung (Owner/Manage) | • Berechtigte können Gruppeneinstellungen ändern (Posting/Kommentare/Approval/Discoverable)<br>• Berechtigte können Mitglieder zuweisen und Permissions setzen (ReadOnly/ReadWrite/Manage) |
...
- Onboarding‑Feed/Guided Start (Content/Guides) im MVP.
