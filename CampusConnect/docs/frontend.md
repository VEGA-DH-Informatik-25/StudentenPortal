...
- Custom German/English/French i18n under `src/app/core/i18n`
...
- `campusconnect.language`: non-sensitive language preference, `de`, `en`, or `fr`
...
Add German, English, and French values for every new user-facing translation key. Use the `TranslatePipe` in templates and `I18n` in TypeScript for translated strings, locale formatting, and localized API error messages.
