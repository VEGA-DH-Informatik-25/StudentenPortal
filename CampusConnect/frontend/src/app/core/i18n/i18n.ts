...
const apiErrorTranslations: Record<string, TranslationKey> = {
  ...
  'No DHBW study plan was found for your course.': 'apiError.noStudyPlan',
  ...
  'The DHBW study plan could not be loaded right now.': 'apiError.studyPlanUnavailable',
  ...
  'This module does not belong to the assigned course plan.': 'apiError.moduleNotInPlan',
